...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to step1() in step1.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your step1.v for the exact path:
    ...
    # For a simple step1, dut.count.value *might* work, depending on Verilator's flattening.
